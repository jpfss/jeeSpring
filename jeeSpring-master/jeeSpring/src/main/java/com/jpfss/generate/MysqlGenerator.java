package com.jpfss.generate;

/**
 * @Package:${package_name}
 * @Title: ${file_name}
 * @Description:MybatisPlus代码生成器
 * @Date: Created in 21:43 2018/1/13
 * @Author: jpfss
 * @Modified:jpfss
 * @version:V1.0
 */
...
public class MysqlGenerator {
    ...
    private static String packageName = "generatedCodes";    //文件路径
    private static String authorName = "jpfss";     //作者
    private static String table = "t_user";                  //table名字
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("jpfss")
                        .setPassword("jpfss")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/jeespring?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
